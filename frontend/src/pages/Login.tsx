...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-6 py-12 transition-colors duration-300 relative overflow-hidden">
      {/* Decorative Blurs */}
      <div className="absolute top-[-20%] right-[-20%] w-[60%] h-[60%] rounded-full bg-brand-indigo/10 blur-[150px] dark:bg-brand-indigo/5"></div>
      <div className="absolute bottom-[-20%] left-[-20%] w-[60%] h-[60%] rounded-full bg-brand-emerald/10 blur-[150px] dark:bg-brand-emerald/5"></div>
        ...
        <div className="p-8 rounded-3xl glass-panel border border-slate-200/60 dark:border-slate-800/60 shadow-xl shadow-slate-950/5 dark:shadow-black/30">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider font-sans">
                Email Address
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-11 pr-4 py-3.5 rounded-2xl bg-slate-100/60 dark:bg-slate-900/50 border border-slate-200/40 dark:border-slate-850/50 focus:border-brand-indigo focus:bg-white dark:focus:bg-slate-950 text-slate-800 dark:text-slate-200 text-sm font-sans focus:outline-none transition-all ${
              ...
              {errors.email && (
                <span className="text-[11px] font-sans font-medium text-red-500 block pl-1">
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <a
                  href="#"
                  className="text-xs font-sans font-semibold text-brand-indigo hover:text-brand-indigo-light"
                >
                  Forgot?
                </a>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full pl-11 pr-12 py-3.5 rounded-2xl bg-slate-100/60 dark:bg-slate-900/50 border border-slate-200/40 dark:border-slate-850/50 focus:border-brand-indigo focus:bg-white dark:focus:bg-slate-950 text-slate-800 dark:text-slate-200 text-sm font-sans focus:outline-none transition-all ${
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-4 rounded-2xl bg-gradient-to-r from-brand-indigo to-brand-purple text-white font-sans font-bold shadow-lg shadow-brand-indigo/15 hover:shadow-brand-indigo/25 active:scale-95 disabled:opacity-50 disabled:scale-100 transition-all flex items-center justify-center gap-2 group cursor-pointer"
            >
